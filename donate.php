     ...
     // print_r($file);
      ...
      if($fileerror == 0)
      {
        ...
        move_uploaded_file($filepath,$destfile);
                      ...
                      $sql =  "INSERT INTO donor (name,gender,email,city,dob,contact_no,save_life_date,password,blood_group,proofimg) VALUES('$name','$gender','$email','$city','$DonorDOB','$contact','0','$password','$blood_group','$destfile')";
        }
...
/*
  ...
  <strong>Data Inserted Succesfully .</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>'; */
  ...
  <strong>Please Agree to Terms and conditions.</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>';
...
<div class="container size">
	<div class="row">
        ...
        <?php if(isset($day)) echo '<option selected="" value="'.$day.'">'.$day.'</option>';?>
          ...
          <?php if(isset($emailError)) echo $emailError; ?>
             ...
             <input type="text" name="contact_no" placeholder="Contact Number" class="form-control" required pattern="^\d{10}$" title="10 numeric characters only" maxlength="10" value="<?php if(isset($contact)) echo $contact; ?>">
            </div><!--End form-group-->
  ...
  <option value="">-- Select --</option><?php if(isset($city)) echo '<option selected="" value="'.$city.'">'.$city.'</option>';?><optgroup title="MUMBAI" label="&raquo; MUMBAI"></optgroup><option value="Bandra" >Bandra</option><option value="Dadar" >Dadar</option><option value="Andheri" >Andheri</option><option value="Borivali" >Borivali</option><optgroup title="PALGHAR" label="&raquo; PALGHAR"></optgroup><option value="Vasai" >Vasai</option><option value="Naigaon" >Naigaon</option><option value="Virar" >Virar</option></select>
            ...
            <br>
            <span><a href="doc.php" target="_blank">Click here to know About Accepted Documents</a></span>
            ...
            <div class="form-inline">
              ...
              <span style="margin-left:10px;"><h6>I' hereby declare that I have read all Terms and Conditions and I am eligible to Donate Blood</h6>
                <a href="TNC.php" target="_blank" >Click here to Check Rules and Terms and Conditions</div><!--End form-group-->
			
					<div class="form-group">
						<button id="submit" name="submit" type="submit" class="btn btn-lg btn-danger center-aligned" style="margin-top: 20px;">SignUp
            </button>
					</div>
				</form>
		</div>
