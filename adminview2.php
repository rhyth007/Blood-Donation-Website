...
//if(isset($SForm)) echo $SForm; 
  ...
  $y=$_POST['id'];
 $sql="UPDATE donor SET verifytwo=1  WHERE id='$y'";
...
if(isset($SForm)) echo $SForm; 
 ...
 $sql="UPDATE donor SET verifytwo=2  WHERE id='$u'";
...
?>
   <a href="adminview.php" class="previous">&laquo; Go Back</a>
   
     <h1> User Donation Verification</h1>
  <div class="container"> 
     <div class="row d-flex justify-content-center">
        <div class="col-lg-11 col-12"></div>
          ...
          <tr>
             ...
             <th class="py-3 text-white">Donate Proof(Certificate)</th>
          ...
          <?php  include 'include/config.php';
           ...
           ?>
            <tr>
              ...
              <td class="pic"width=400 height=300> <img src="<?php echo $result['donateproof'];?>"width=300 height=300 ></td>
              <td class="status" width=400 > 

     <?php
              
              if($result['verifytwo']=='0' || $result['verifytwo']=='3'){ 
              echo'<form target="" method="post">
               ...
               if($result['verifytwo']=='1')  {
                  echo 'Accepted';
                             }
                  if($result['verifytwo']=='2')  {
                  echo 'Rejected';
                          }              
